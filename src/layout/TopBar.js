...
function UserInfoDiv(props) {
  ...
  if(loggedIn) {
    return (<>
        <a className="nav-link dropdown-toggle" href="#userDropdown" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          <span className="mr-2 d-none d-lg-inline text-gray-600 small">Valerie Luna</span>
          <img className="img-profile rounded-circle" alt="no alt" src="https://source.unsplash.com/QAB-WJcbgJk/60x60"/>
        </a>
        {/* Dropdown - User Information */}
        <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
          <a className="dropdown-item" href="#userDropdown">
            <i className="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>
            그냥 의미 없는 메뉴 아이템
          </a>
          <div className="dropdown-divider"></div>
          <a className="dropdown-item" href="#userDropdown" data-toggle="modal" data-target="#logoutModal">
